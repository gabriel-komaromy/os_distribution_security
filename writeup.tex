...
to an attacker than application software.\\[\baselineskip]
...
powerful.\\[\baselineskip]
The open-source software model possesses a somewhat different attack surface that its closed- or shared-source counterparts.
