...
\section{Distributing an Operating System}

Body of text goes here\ldots

\subsection{Building a Release}

The specific processes by which a new version of an operating system
is built differ between development teams.
...
\subsubsection{Changing the System}
...
\subsubsection{Compiling into ISO}

Body of text goes here\ldots

\subsubsection{Overseeing Release}

Body of text goes here\ldots

\subsection{Mirroring a Release}
...
\bibitem{GIMPSourceForge}
    M.~Schumacher, ``GIMP project's official statement on SourceForge's actions'',\bibspace\ Internet:\bibspace\ \url{https://mail.gnome.org/archives/gimp-developer-list/2015-May/msg00144.html}, accessed April 2016.
\bibitem{SourceForgePolicy}
    ``Third\bibspace\ party\bibspace\ offers\bibspace\ will\bibspace\ be\bibspace\ presented\bibspace\ with\bibspace\ opt-in\bibspace\ projects\bibspace\ only'',\bibspace\ Internet:\bibspace\ \url{https://sourceforge.net/blog/third-party-offers-will-be-presented-with-opt-in-projects-only/}, accessed April 2016.
\bibitem{NmapSourceForge}
    ``SourceForge hijacks the Nmap SourceForge account'',\bibspace\ Internet:\bibspace\ \url{http://seclists.org/nmap-dev/2015/q2/194}, accessed April 2016.
\bibitem{DistroWatch}
    ``DistroWatch\bibspace\ page\bibspace\ hit\bibspace\ ranking'',\bibspace\ Internet:\bibspace\ \url{https://distrowatch.com/dwres.php?resource=popularity}, accessed April 2016.
\bibitem{ManjaroDownload}
    ``Download\bibspace\ Manjaro'',\bibspace\ Internet:\bibspace\ \url{https://wiki.manjaro.org/index.php?title=Download_Manjaro}, accessed April 2016.
