...
operating system image may do so from a dozen or more sources~\cite{lou2006adaptive}.\\
...
which occur at a fairly steady rate~\cite{lou2006adaptive}.\\
...
a collision if an undetectable modification is made, an attack on
...
of the torrent, content poisoning is made very difficult~\cite{lou2006adaptive}.\\
...
of seeders can grow. If a malicious \texttt{.torrent} file is created
...
population is both a strength and a weakness~\cite{lou2006adaptive}.
...
\begin{tabular}{|l|l|l|l|l|}
    ...
    \hline
\end{tabular}
\caption{\label{tab:distros}First-party availability of distribution methods}
\end{table}
