...
% FreeBSD release process documentation
% https://www.freebsd.org/doc/en/articles/releng/release-proc.html
...
% FreeBSD FTP site documentation
% https://www.freebsd.org/doc/en/articles/releng/distribution.html
...
% FreeBSD mirroring documentation
...
% FreeBSD qualifications
% https://www.freebsd.org/doc/en_US.ISO8859-1/articles/hubs/mirror-requirements.html
% Ubuntu mirror guidelines
...
unrelated to hardware, such as requirements about frequency of syncronization and refusal of upload connections.
...
% rsync's checksum math in detail
% https://rsync.samba.org/tech_report/node3.html
% describes --checksum option
...
each with separate advantages and disadvantages. FTP and HTTP are very
...
% Measurements and round trip times (ftp vs http)
% http://www.isi.edu/lsam/publications/http-perf/#intro
The File Transfer Protocol is older than HTTP and features a few
...
messages and another, separate, connection for the file transfer itself.\\
\indent FTP is considered to be slightly slower than HTTP except
in certain cases involving the transfer of large files,
among which certainly are operating system ISOs. FTP transfers do not
...
\indent 
The HyperText Transfer Protocol overlaps the function of FTP, having been
...
time of small files and does not require a control channel.
...
ISO downloads over HTTPs, although the webpages themselves sometimes were.
